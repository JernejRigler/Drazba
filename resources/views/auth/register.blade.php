                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6 offset-md-4">
                        <div class="form-check">
                            <input type="hidden" name="obvescanje" value="0">
                            <input class="form-check-input" type="checkbox" name="obvescanje" id="obvescanje" value="1" @checked(old('obvescanje', true))>
                            <label class="form-check-label" for="obvescanje">
